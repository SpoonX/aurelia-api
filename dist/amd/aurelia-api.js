define(['exports', 'extend', 'aurelia-fetch-client', 'aurelia-dependency-injection', 'aurelia-path'], function (exports, _extend, _aureliaFetchClient, _aureliaDependencyInjection, _aureliaPath) {
  'use strict';
